...
def create_model(opts):
    ...
    if opts.gen=="cycle":
        ...
        G_XtoY = CycleGeneratorMixer(embed_dim=opts.g_conv_dim, image_size=opts.image_size, patch_dim=opts.patch_dim, transform_layers=opts.blocks, patch_size=opts.patch)
        G_YtoX = CycleGeneratorMixer(embed_dim=opts.g_conv_dim, image_size=opts.image_size, patch_dim=opts.patch_dim, transform_layers=opts.blocks, patch_size=opts.patch)
